...
public class iloview {
    ...
    public void run() {
        ...
        while (true) {
            ...
            else if (ch.equals("3")) {reservation();}
    ...
    public void reservation() {
        while (true){
            ...
            else if (ch.equals("2")) {reservFindAll();}
            else if (ch.equals("3")) {reservUpdate();}
            else if (ch.equals("4")) {reservDelete();}
